...
goog.provide('Blockly.Msg.zh.HK');
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "將條件添加到'if'積木。";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "加入一個最終，所有條件下都都執行的區塊到'if'積木中";
Blockly.Msg.CONTROLS_IF_HELPURL = "https://github.com/google/blockly/wiki/IfElse";  // untranslated
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "添加、 刪除或重新排列各區塊來此重新配置這個'if'積木。";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "else";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "else if";
Blockly.Msg.CONTROLS_IF_MSG_IF = "if";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "當值為 true 時，執行一些語句";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "當值為 true 時，執行第一個語句，否則則執行第二個語句";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "如果第一個值為 true，則執行第一個語句。否則當第二個值為 true 時，則執行第二個語句";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "如果第一個值為 true，則執行第一個語句。否則當第二個值為 true 時，則執行第二個語句。如果前幾個敘述都不為 true，則執行最後一個語句";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "當值仍為 false 時，重覆執行一些語句";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "當值仍為 true 時，重覆執行一些語句";
...
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "倒數第#項";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP = "如果該列表為空，則返回 true。";
...
Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT = "由列表造出字串";
Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST = "由字串造出列表";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN = "合併字串列表成一字串。(用指定字串分隔)";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT = "分拆字串成一字串列表。(用指定字串分隔)";
Blockly.Msg.LISTS_SPLIT_WITH_DELIMITER = "分隔字串";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "如果這兩個輸入區塊內容相等，返回 true。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "如果第一個輸入大於第二個輸入，返回 true。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "如果第一個輸入大於或等於第二個輸入，返回 true。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "如果第一個輸入小於第二個輸入，返回 true。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "如果第一個輸入是小於或等於第二個輸入，返回 true。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "如果這兩個輸入區塊內容不相等，返回 true。";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "https://github.com/google/blockly/wiki/Logic#not";  // untranslated
Blockly.Msg.LOGIC_NEGATE_TITLE = "not %1";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "如果輸入的值是 false，則返回 true。如果輸入的值是 true 返回 false。";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "如果這兩個輸入值都為 true，則返回 true。";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "如果至少一個輸入的值為 true，返回 true。";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "檢查 'test' 中的條件。如果條件為 true，將返回 '如果為 true' 值 ；否則，返回 '如果為 false' 的值。";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER = "返回第一個數字為基數、第二個數字為指數的結果。";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "限制數字 %1 不低於 %2 及不高於 %3";
...
Blockly.Msg.MATH_IS_TOOLTIP = "如果數字是偶數，奇數，非負整數，正數、負數或如果它是可被某數字整除，則返回 true 或 false。";
Blockly.Msg.MATH_IS_WHOLE = "是非負整數";
Blockly.Msg.MATH_MODULO_HELPURL = "https://zh.wikipedia.org/wiki/模除";
Blockly.Msg.MATH_MODULO_TITLE = "取 %1 ÷ %2 的餘數";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "返回介於 0.0 (包含) 到 1.0 (不包含) 之間的隨機數";
Blockly.Msg.MATH_RANDOM_INT_HELPURL = "https://zh.wikipedia.org/wiki/隨機數生成器";
Blockly.Msg.MATH_RANDOM_INT_TITLE = "%1 到 %2 之間(含)的隨機整數";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "返回限制的數字區間內的隨機數字";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "返回指定數字指數的 e 的冪次。";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN = "返回指定數字的自然對數。";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 = "返回指定數字的對數。";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "返回指定數字的負數。";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_ACOS = "返回反餘弦值得到的角度(度數)。";
Blockly.Msg.MATH_TRIG_TOOLTIP_ASIN = "返回反正弦值得到的角度(度數)。";
Blockly.Msg.MATH_TRIG_TOOLTIP_ATAN = "返回反正切值得到的角度(度數)。";
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "返回指定角度的餘弦值(度數)。";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "返回指定角度的正弦值(度數)。";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "返回指定角度的正切值(度數)。";
Blockly.Msg.ME = "我";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "函數";
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "宣告";
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "創建一個無返回值的函數。";
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";  // untranslated
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "返回";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "創建一個有返回值的函數。";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP = "增加參數";  // untranslated
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "參數";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP = "增加、刪除參數 或 更改參數次序"; 
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "加一些文字到變量 '%1' 後。";
...
Blockly.Msg.HKOI_PRINTLN_TITLE = "輸出行 %1";
