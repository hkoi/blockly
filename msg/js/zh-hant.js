...
Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "無法刪除變量「%1」，因為這是功能「%2」定義的一部份內容";
...
Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] = "遍歷每個清單中的項目，將變量「%1」設定到該項目中，然後執行某些陳述式。";
Blockly.Msg["CONTROLS_FOR_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#count-with";  // untranslated
Blockly.Msg["CONTROLS_FOR_TITLE"] = "循環計數 %1 從 %2 到 %3 每次增加 %4";
Blockly.Msg["CONTROLS_FOR_TOOLTIP"] = "從起始數到結尾數中取出變量「%1」的值，按指定的時間間隔，執行指定的區塊。";
Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = "添加條件到「if」積木。";
Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] = "加入一個最終、所有條件都執行的部份到「if」區塊中。";
Blockly.Msg["CONTROLS_IF_HELPURL"] = "https://github.com/google/blockly/wiki/IfElse";  // untranslated
Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] = "添加、刪除或重新排列各部份以重新配置這個「if」區塊。";
...
Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "當值仍為 false 時，執行一些陳述式。";
Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "當值仍為 true 時，執行一些陳述式。";
Blockly.Msg["DELETE_ALL_BLOCKS"] = "刪除全部 %1 個區塊？";
Blockly.Msg["DELETE_BLOCK"] = "刪除區塊";
Blockly.Msg["DELETE_VARIABLE"] = "刪除變量「%1」";
Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] = "刪除使用%1次的「%2」變量？";
...
Blockly.Msg["HKOI_READ_VARS_PROMPT"] = "請輸入以下變量的值 (以空格分隔):";
Blockly.Msg["HKOI_RETURN"] = "終止程序";
Blockly.Msg["HKOI_RETURN_WARNING"] = "只能在主程序中使用此方塊。";
...
Blockly.Msg["IOS_VARIABLES_EMPTY_NAME_ERROR"] = "您不能使用空的變量名稱。";
Blockly.Msg["IOS_VARIABLES_RENAME_BUTTON"] = "重新命名";
Blockly.Msg["IOS_VARIABLES_VARIABLE_NAME"] = "變量名稱";
...
Blockly.Msg["LISTS_SPLIT_NUMERIC_LIST_FROM_TEXT"] = "make list of numbers from text";  // untranslated
...
Blockly.Msg["LISTS_SPLIT_TOOLTIP_SPLIT_NUMERIC"] = "Split text into a list of texts, breaking at each delimiter.";  // untranslated
...
Blockly.Msg["MATH_CHANGE_TOOLTIP"] = "將數字加到變量「%1」。";
...
Blockly.Msg["NEW_COLOUR_VARIABLE"] = "建立顏色變量……";
Blockly.Msg["NEW_NUMBER_VARIABLE"] = "建立數值變量……";
Blockly.Msg["NEW_STRING_VARIABLE"] = "建立字串變量……";
Blockly.Msg["NEW_VARIABLE"] = "建立變量…";
Blockly.Msg["NEW_VARIABLE_TITLE"] = "新變量名稱：";
Blockly.Msg["NEW_VARIABLE_TYPE_TITLE"] = "新變量類型：";
...
Blockly.Msg["TEXT_APPEND_TOOLTIP"] = "添加一些文字到變量「%1」之後。";
...
Blockly.Msg["VARIABLES_SET_TOOLTIP"] = "設定此變量，好和輸入結果相等。";
Blockly.Msg["VARIABLE_ALREADY_EXISTS"] = "一個名為「%1」的變量已存在。";
Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "已存在名為「%1」，且用於其它類型「%2」的變量。";
